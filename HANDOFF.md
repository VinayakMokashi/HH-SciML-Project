...
> **Vinayak's answer, 2026-08-28: "Sure" \u2014 taken as YES, the archival goes to three as
> well, so the two bylines match.** It was a one-word reply to an either/or, so
> **CONFIRM IT IN ONE LINE before editing `paper/main.tex:172`.** Nothing has been edited:
> the archival byline is A12 / post-deadline work and there is no reason to touch it under
> deadline pressure. **When it is edited, D4's disclosure sentence must be fixed in the same
> pass** \u2014 "shares four of this paper's five authors" becomes two of three.
