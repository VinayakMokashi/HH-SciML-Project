...
> ## START HERE — 2026-08-29, END OF THE OVERNIGHT AUDIT. THIS BOX IS THE CURRENT STATE.
...
>
> ### THE PAPER IS FINISHED. THE AUDIT IS CLOSED. WHAT IS LEFT IS ERRANDS.
> **Nothing below needs writing, analysis, a new number or a new experiment.** Twelve audit
> rounds. **All SIXTEEN checks green** (§8 — thirteen named checks plus check_numbers,
> check_tex_sanity and check_undefined_macros run twice each). The bundle is built and
> byte-identical to its source.
>
> **DO NOT START ANOTHER AUDIT ROUND.** The stopping rule was agreed with Vinayak and both of
> the last two rounds met it: zero body-affecting findings, and >75 % of candidates refuted.
> Round 10 confirmed 4 of 9 (44 %), round 11 **7 of 29 (24 %)**, round 12 **2 of 22 (9 %)**.
> At a 9 % true-positive rate the next round is likelier to damage the paper than improve it.
> **If you want to reopen it, the burden is to name an axis never run — not to re-run these.**
> Axes already exhausted: body prose · figures and tables · the cut internally ·
> cross-manuscript · the compiled PDFs · `checklist.tex` (four separate passes) ·
> mentor-ask coverage · the paragraph-by-paragraph LIFT audit of the cut against the archival.
>
> ### ~~THE ONE THING BLOCKING SUBMISSION~~ — CLEARED 2026-08-29 BY MENTOR REVIEW 3.
> **There is NO blocker.** Raj needs no profile-ID string: on the OpenReview submission form,
> **type "Raj Dandekar" into the author box and pick him from the dropdown** — he appears with
> the Vizuara AI Labs / principal researcher affiliation. Prathamesh confirmed this on video.
> The earlier note here said the ID was the one hard blocker and could not be looked up (both
> OpenReview APIs 403 to unauthenticated requests). That was true of the *API* and irrelevant to
> the *form*. **Still do not guess a `~Raj_...` string; use the dropdown.**
>
> **What remains is his offer of one final read before you submit, which he made explicitly:**
> *"If you want me to review your paper before that, you can send me one time."* Mentor review 3
> is fully discharged (see §4o), so that read is a confirmation, not a work item.
>
> ### DEADLINE: 2 Sep 2026 23:59 AoE = 3 Sep 17:29 IST.
> Verified by Vinayak on the CFP. The earlier 30 Aug date on the OpenReview form is superseded;
> **work to 2 Sep.** (An older note in this file said to work to 30 Aug until the form caught
> up — that is obsolete.)
>
> ### THE THREE-LINE FILE MAP. Getting this wrong is how a session wastes a round.
> | what | path | note |
> |---|---|---|
> | **THE SUBMISSION — edit this** | `paper/sim2science/main.tex` + `paper/sim2science/checklist.tex` | double-blind, no byline |
> | **THE ARCHIVAL** | `paper/main.tex` | real byline, 3 authors, NOT submitted |
> | **WHAT YOU COMPILE AND UPLOAD** | `sim2science_upload/main.tex` | **BUILD OUTPUT.** Destroyed and rewritten by every `make_sim2science_bundle.py` run — a hand-edit here is lost silently |
>
...
### WHAT ACTUALLY REMAINS — all of it errands, none of it writing
**Rewritten in full 2026-08-29 after round 12. This list is COMPLETE and ORDERED — each item's
prerequisite comes before it. Nothing here is analysis; every one is a decision or an errand.**

#### BEFORE THE DEADLINE (2 Sep 23:59 AoE = 3 Sep 17:29 IST)
