...
| Reciprocal reviewer | **Nominate Prathamesh.** He volunteered and will send his ID. He is a co-author; **Vinayak remains sole first author and corresponding author.** |
...
- **Appendix is allowed but 4-5 pages, not 20, and must not be a dumping ground** to make
  the main body fit. *"to shift everything in appendix is not a good idea."*
...
second round of feedback on the big paper afterwards.
...
| N4 | Figures for the main body: the NODE/UDE forecast plot **and one symbolic-recovery graph**. | N2 | |
...
| A8 | Second round of mentor feedback on the big paper. | He will send it after Sim2Science. |
