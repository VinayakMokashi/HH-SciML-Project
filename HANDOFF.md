...
```
Current state (2026-08-21): **all nine green — extract_metrics 322/322 macros match disk · check_numbers OK (0 flagged) · check_claims 0 errors · lint_prose clean · verify_references 38 refs, 36 verified, 2 review · tex_sanity clean · bib_sanity clean · check_provenance_refs clean · check_consistency 24 sites across 11 groups agree.** `doctor.py` reports 3 FAILs; those are the broken local MiKTeX and are expected — compilation is Overleaf-only.
